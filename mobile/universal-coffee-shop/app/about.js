...
const styles = StyleSheet.create({
  ...
  scrollView:   { flex: 1 },
  header:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 15, borderBottomWidth: 2, borderBottomColor: '#000' },
  backButton:   { width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
  headerTitle:  { fontSize: 24, fontFamily: 'Anton-Regular' },
  content:      { padding: 20 },
  logoContainer:{ alignItems: 'center', paddingVertical: 30 },
  logo:         { fontSize: 64, marginBottom: 10 },
  appName:      { fontSize: 32, fontFamily: 'Anton-Regular', marginBottom: 5 },
  version:      { fontSize: 14, color: '#666' },
  section:      { marginTop: 30 },
  sectionTitle: { fontSize: 14, fontFamily: 'Anton-Regular', color: '#666', marginBottom: 15, letterSpacing: 1 },
  description:  { fontSize: 16, lineHeight: 24, color: '#333' },
  featureList:  { gap: 12 },
  featureItem:  { flexDirection: 'row', alignItems: 'center', gap: 12 },
  featureText:  { fontSize: 16, flex: 1 },
  linkItem:     { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 15, borderBottomWidth: 1, borderBottomColor: '#E0E0E0' },
  linkText:     { fontSize: 16, fontFamily: 'Anton-Regular' },
  socialLinks:  { flexDirection: 'row', gap: 15 },
  socialButton: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#F0F0F0', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#000' },
  footer:       { marginTop: 40, paddingTop: 20, borderTopWidth: 2, borderTopColor: '#000', alignItems: 'center' },
  footerText:   { fontSize: 14, color: '#666', textAlign: 'center', marginVertical: 5 },
});