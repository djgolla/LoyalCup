...
class CloverAdapter(POSAdapter):
    ...
    def get_authorization_url(self, shop_id: str, redirect_uri: str, state: str) -> str:
        raise NotImplementedError("Clover OAuth flow not implemented yet")

    async def exchange_code_for_tokens(self, code: str, redirect_uri: str) -> Dict[str, Any]:
        raise NotImplementedError("Clover token exchange not implemented yet")

    async def list_locations(self, access_token: str) -> List[POSLocation]:
        raise NotImplementedError("Clover locations not implemented yet")

    async def fetch_catalog(self, access_token: str, location_id: Optional[str]) -> POSCatalogSnapshot:
        raise NotImplementedError("Clover catalog sync not implemented yet")

    async def create_order(self, access_token: str, location_id: str, order_payload: Dict[str, Any]) -> Dict[str, Any]:
        raise NotImplementedError("Clover create order not implemented yet")